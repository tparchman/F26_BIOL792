...
**See Linux_suggestions_for_setup_PC.md** in this directory for more tips on setup, tools, package installation, etc. As we get through the next few weeks you will want to revisit this guide.
